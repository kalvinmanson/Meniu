...
class QuestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quest" do
    assert_difference('Quest.count') do
      post quests_url, params: { quest: { quest: @quest.quest, result: @quest.result, user_id: @quest.user_id } }
    end
  ...
  test "should update quest" do
    patch quest_url(@quest), params: { quest: { quest: @quest.quest, result: @quest.result, user_id: @quest.user_id } }
